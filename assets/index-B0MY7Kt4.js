...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Kn,depthTest:!1,depthWrite:!1})}function Jx(n,e,t){const i=new Float32Array(Vi),r=new G(0,1,0);return new Un({name:"SphericalGaussianBlur",defines:{n:Vi,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:Ea(),fragmentShader:`
		...
		`,blending:Kn,depthTest:!1,depthWrite:!1})}function Uu(){return new Un({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ea(),fragmentShader:`
		...
		`,blending:Kn,depthTest:!1,depthWrite:!1})}function Nu(){return new Un({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ea(),fragmentShader:`
...
`)+`
`+d);const A=b+g+a,y=b+d+o,C=Gu(r,r.VERTEX_SHADER,A),R=Gu(r,r.FRAGMENT_SHADER,y);r.attachShader(S,C),r.attachShader(S,R),t.index0AttributeName!==void 0?r.bindAttribLocation(S,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(S,0,"position"),r.linkProgram(S);function T(L){if(n.debug.checkShaderErrors){const N=r.getProgramInfoLog(S)||"",B=r.getShaderInfoLog(C)||"",Z=r.getShaderInfoLog(R)||"",j=N.trim(),q=B.trim(),V=Z.trim();let J=!0,ge=!0;if(r.getProgramParameter(S,r.LINK_STATUS)===!1)if(J=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,S,C,R);else{const de=Wu(r,C,"vertex"),_e=Wu(r,R,"fragment");Qe("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(S,r.VALIDATE_STATUS)+`
